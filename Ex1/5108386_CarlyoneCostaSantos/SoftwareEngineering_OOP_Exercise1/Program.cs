public class Program
{
    public static void Main(string[] args)
    {
        ...
        Member carlyone = new Member("Carlyone Santos", 37, "Premium");
        Member beatriz = new Member("Beatriz Santos", 36, "VIP");
        Member otherMember = new Member("Other Member", -12, "Standard");
        ...
        Console.WriteLine($"\nMember: {carlyone.Name}, Age: {carlyone.Age}, Membership level: {carlyone.MembershipLevel}, Books borrowed: {carlyone.GetBooksBorrowed()} ");
        Console.WriteLine($"Member: {beatriz.Name}, Age: {beatriz.Age}, Membership level: {beatriz.MembershipLevel}, Books borrowed: {beatriz.GetBooksBorrowed()} ");
        Console.WriteLine($"Member: {otherMember.Name}, Age: {otherMember.Age}, Membership level: {otherMember.MembershipLevel}, Books borrowed: {otherMember.GetBooksBorrowed()} ");
