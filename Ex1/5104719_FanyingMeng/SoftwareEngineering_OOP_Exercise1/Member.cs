public class Member
{
    ...
    private static int standardMembersLimit = 3;
    private static int premiumMembersLimit = 5;
    private static int vipMembersLimit = 10;
    // ============================
    // Constructor
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        // placeholder
        if (MembershipLevel == "Standard") return standardMembersLimit;
        if (MembershipLevel == "Premium") return premiumMembersLimit;
        if (MembershipLevel == "VIP") return vipMembersLimit;
        return 0;
    }
    ...
    public void BorrowBook()
    {
        ...
        if(GetMaxBorrowLimit()-booksBorrowed > 0)
        {
            booksBorrowed++;
            TotalBooksBorrowed++;
        }
