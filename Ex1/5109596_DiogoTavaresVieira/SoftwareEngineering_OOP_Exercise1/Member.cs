public class Member
{
    ...
    private int booksBorrowed { get; set; }
    ...
    private static int _standardMaxBorrow = 3;
    private static int _premiumMaxBorrow = 5;
    private static int _vipMaxBorrow = 10;
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        if (MembershipLevel == "Standard")
            return _standardMaxBorrow;
        else if (MembershipLevel == "Premium")
            return _premiumMaxBorrow;
        else if (MembershipLevel == "VIP")
            return _vipMaxBorrow;
        else
            return 0;
    }
    ...
    public void BorrowBook()
    {
        ...
        int maxLimit = GetMaxBorrowLimit();

        if (booksBorrowed < maxLimit)
        {
            booksBorrowed++;
            TotalBooksBorrowed++;
        }
